...
%    }%
%  }
% ADDON: Установка абзацного отступа 9.5mm для параграфа 4 уровня,
% разрешить отступ для текста после заголовка
  \renewcommand{\paragraph}{%
...
%    }%
%  }
% ADDON: Установка абзацного отступа 9.5mm для подпараграфа 5 уровня,
% разрешить отступ для текста после заголовка
  \renewcommand{\subparagraph}{%
