 ...
 * \file
 *
 * \brief Файл с определениями классов, соответствующих ISO 10303-44:2021(E).
 *
 */
...
namespace express {
  ...
  private:
    ...
    identifier* reference_designator;
  ...
  public:
    ...
    assembly_component_usage(const identifier& Id,
      ...
      reference_designator = new identifier(Reference_designator);
      add_attr_info(STEP_ATTR_LIST({
                                     {"reference_designator", reference_designator, true}
        }, this));
    }

    ~assembly_component_usage() {
      delete reference_designator;
    }
  };
