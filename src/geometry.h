 ...
 * \file
 *
 * \brief Файл с объявлениями классов геометрических примитивов.
 */
...
namespace geometry {
  ...
  public:
    ...
    */
    ...
    /*
    * \brief Отладочный вывод значения ветора.
    */
    void print() const;

    /**
     * \brief Проверка: равенство координат (векторов) с точностью по умолчанию.
     *
    ...
    /**
     * \brief Проверка: является ли вектор нулевым (с указанной точностью)
     * \param [in] epsilon точность, с которой производится сравнение
    ...
    /**
     * \brief Получить координату X вектора
     * \return координату X вектора.
     */
    double getX() const { return X; }

    /**
     * \brief Получить координату Y вектора
     * \return координату Y вектора
     */
    double getY() const { return Y; }

    /**
     * \brief Получить координату Z вектора
     * \return координату Z вектора.
     */
    double getZ() const { return Z; }

    /**
     * \brief Получить смешанное произведение векторов p1, p2 и p3
    ...
    /**
     * \brief Проверить, лежат ли четыре точки в одной плоскости (с указанной точночтью)?
    ...
    /**
     * \brief Проверить, являются ли два вектора коллинеарными (с указанной точночтью)?
     * \param [in] v1 первый вектор
     * \param [in] v2 второй вектор
     * \param [in] epsilon точность, с которой производится сравнение
    ...
    /**
     * \brief Проверить, лежат ли три точки на линии (с указанной точночтью)?
     * \param [in] p0 координаты первой точки
     * \param [in] p1 координаты второй точки
     * \param [in] p2 координаты третьей точки
     * \param [in] epsilon точность, с которой производится сравнение
