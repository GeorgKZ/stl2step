 ...
 * \file
 *
 * \brief Файл с определениями классов, соответствующих ISO 10303-46:2021(E)
 */
...
//  /** \brief Конструктор из типа approximation_tolerance */
//  presentation_style_select(const approximation_tolerance* t);

    /** \brief Конструктор из типа curve_style */
    presentation_style_select(const curve_style* t);

//  /** \brief Конструктор из типа externally_defined_style */
//  presentation_style_select(const externally_defined_style* t);

    /** \brief Конструктор из типа fill_area_style */
    presentation_style_select(const fill_area_style* t);

    /** \brief Конструктор из типа null_style */
    presentation_style_select(const null_style* t);
    ...
    /** \brief Конструктор из типа surface_style_usage */
    presentation_style_select(const surface_style_usage* t);
...
//  /** \brief Конструктор из типа curve_style_font_and_scaling */
//  curve_font_or_scaled_curve_font_select(const curve_style_font_and_scaling* t);

    /** \brief Конструктор из типа curve_style_font_select */
    curve_font_or_scaled_curve_font_select(const curve_style_font_select* t);
  };
  ...
  public:
    ...
    /** \brief Конструктор из типа pre_defined_curve_font */
    curve_style_font_select(const pre_defined_curve_font* t);
  };
  ...
  public:
    ...
    /** \brief Конструктор из типа fill_area_style_colour */
    fill_style_select(const fill_area_style_colour* t);
...
//  /** \brief Конструктор из типа pre_defined_surface_side_style */
//  surface_side_style_select(const pre_defined_surface_side_style* t);

    /** \brief Конструктор из типа surface_side_style */
    surface_side_style_select(const surface_side_style* t);
  };
...
//  /** \brief Конструктор из типа surface_style_boundary */
//  surface_style_element_select(const surface_style_boundary* t);
//  /** \brief Конструктор из типа surface_style_control_grid */
//  surface_style_element_select(const surface_style_control_grid* t);

    /** \brief Конструктор из типа surface_style_fill_area */
    surface_style_element_select(const surface_style_fill_area* t);

//  /** \brief Конструктор из типа surface_style_parameter_line */
//  surface_style_element_select(const surface_style_parameter_line* t);

    /** \brief Конструктор из типа surface_style_rendering */
    surface_style_element_select(const surface_style_rendering* t);

//  /** \brief Конструктор из типа surface_style_segmentation_curve */
//  surface_style_element_select(const surface_style_segmentation_curve* t);
//  /** \brief Конструктор из типа surface_style_silhouette */
//  surface_style_element_select(const surface_style_silhouette* t);
  };
   ...
   *
   * <SMALL>EXAMPLE A symbol is defined using two <B>annotation_curve_occurrences</B>, which are
   ...
   * null: the \ref express::representation_item "representation_item" to which the style is applied shall be presented using
  ...
  private:
    ...
    enum
      ...
      value {
      /**
       * the \ref express::representation_item "representation_item" to which the style is applied shall be presented using
       * the style or styles contained in its definition, if any.
       */
      null = 0,
    };
  ...
  public:
    ...
    static const value null = value::null;

    /** \brief Конструктор неопределённого типа */
    null_style() : ENUMERATION(false), _x(null) {
    }

    /** \brief Конструктор из типа null_stype::value */
    null_style(value v) : _x(v) {
    }

    /** \brief Деструктор */
    virtual ~null_style() = default;
    ...
    std::string print_value() const {
      ...
      case null:   s << "$"; break;
      default:
        throw exception {"null_style::print_value(): Wrong null_style::value"};
        break;
      }
      return s.str();
    }
  ...
  public:
    ...
    /** \brief Конструктор из типа surface_style_reflectance_ambient */
    rendering_properties_select(const surface_style_reflectance_ambient* t);

    /** \brief Конструктор из типа surface_style_transparent */
    rendering_properties_select(const surface_style_transparent* t);
  };
  ...
  public:
    ...
    /** \brief Конструктор из типа geometric_representation_item */
    styled_item_target(const geometric_representation_item* t);

//  /** \brief Конструктор из типа mapped_item */
//  styled_item_target(const mapped_item* t);

    /** \brief Конструктор из типа representation_or_representation_reference */
    styled_item_target(const representation_or_representation_reference* t);

    /** \brief Конструктор из типа topological_representation_item */
    styled_item_target(const topological_representation_item* t);
  };
  ...
  public:
    ...
    static const value positive = value::positive;
    static const value negative = value::negative;
    static const value both     = value::both;

    /** \brief Конструктор неопределённого типа */
    surface_side() : ENUMERATION(false), _x(both) {
    }

    /** \brief Конструктор */
    surface_side(value v) : _x(v) {
    }

    /** \brief Деструктор */
    virtual ~surface_side() = default;
    ...
    std::string print_value() const {
      ...
      default:
        throw exception {"surface_side::print_value(): Wrong surface_side::value"};
        break;
      }
      return s.str();
    }
  ...
  public:
    ...
    size_select(const positive_length_measure* t);

    /** \brief Конструктор из типа measure_with_unit */
    size_select(const measure_with_unit* t);

    /** \brief Конструктор из типа descriptive_measure */
    size_select(const descriptive_measure* t);

//  /** \brief Конструктор из типа pre_defined_size */
//  size_select(const pre_defined_size* t);
  };
  ...
  public:
    ...
    SET<const presentation_style_assignment*> styles;
    const styled_item_target* item;


    styled_item(const std::string& Name, const styled_item_target* Item) :
...
//    }
  ...
  public:
    ...
    virtual ~presentation_style_assignment() = default;
...
//    }
   ...
   */
  class surface_style_reflectance_ambient : public GENERIC_ENTITY {
   ...
   */
  class surface_style_rendering : public GENERIC_ENTITY {
  ...
  public:
    ...
    /** \brief Деструктор. */
    virtual ~surface_style_rendering_with_properties() = default;
...
//    }
   ...
   */
  class surface_style_transparent : public GENERIC_ENTITY {
  ...
  public:
    ...
    /** \brief Деструктор. */
    virtual ~surface_style_transparent() = default;
  };
  ...
  public:
     ...
     */
    SET<const fill_style_select*> fill_styles;


    // Конструктор
    fill_area_style(const std::string& Name) :
      fill_styles(1, INTEGER()) {
      name = new label(Name);
      add_attr_info(STEP_ATTR_LIST({
                                     {"name", name},
...
//    }
   ...
   *
   */
  class fill_area_style_colour : public GENERIC_ENTITY {
   ...
   *
   */
  class colour : public GENERIC_ENTITY {
  ...
  public:
    ...
    surface_style_usage(const surface_side& Side, const surface_side_style_select* Style) : side(Side) {
      style = Style;
      add_attr_info(STEP_ATTR_LIST({
                                     {"side", &side},
                                     {"style", style},
    ...
    virtual ~surface_style_usage() = default;
  };
...
//    }
  ...
  public:
    ...
    /** \brief Конструктор из типа presentation_representation */
    ...
    bool is_presentation_representation() const {
      return get_type_name().compare("presentation_representation");
    }
    bool is_representation_item() const {
      return get_type_name().compare("representation_item");
    }
   ...
   *
   */
  class presentation_layer_assignment : public GENERIC_ENTITY {
