 ...
 * \file
 *
 * \brief Заголовочный файл с определениями классов, соответствующих ГОСТ Р ИСО 10303-514-2007.
 */
  ...
  ENTITY advanced_brep_shape_representation
    ...
    WHERE
      ...
      WR4: SIZEOF (QUERY (msb <* QUERY (it <* items | ('AIC_ADVANCED_BREP.MANIFOLD_SOLID_BREP' IN TYPEOF(it))) |
                                                        ('AIC_ADVANCED_BREP.ORIENTED_CLOSED_SHELL' IN TYPEOF(msb\manifold_solid_brep. outer)))) = 0;
      ...
      WR6: SIZEOF(QUERY ( mi <* QUERY ( it <* items | ('AIC_ADVANCED_BREP.MAPPED_ITEM' IN TYPEOF(it))) | (NOT ('AIC_ADVANCED_BREP.ADVANCED_BREP_SHAPE_REPRESENTATION' IN
