 ...
 * \file
 *
 * \brief Заголовочный файл с определениями классов, соответствующих ГОСТ Р ИСО 10303-517-2009.
 */
...
class mechanical_design_geometric_presentation_representation : public representation {
  public:
    ...
    // Конструктор
    mechanical_design_geometric_presentation_representation(const std::string &Name, const representation_context *Context_of_items) : representation(Name, Context_of_items) {
    }
...
public:
  ...
  STEP_TYPE_SELECT_CONSTRUCTOR_DEF(mechanical_design_geometric_presentation_representation_items, axis2_placement);
//  STEP_TYPE_SELECT_CONSTRUCTOR_DEF(mechanical_design_geometric_presentation_representation_items, camera_model_d3);
//  STEP_TYPE_SELECT_CONSTRUCTOR_DEF(mechanical_design_geometric_presentation_representation_items, mapped_item);
  STEP_TYPE_SELECT_CONSTRUCTOR_DEF(mechanical_design_geometric_presentation_representation_items, styled_item);
};
